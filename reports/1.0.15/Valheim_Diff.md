...
| **Transpiler Hooks Audited** | `12` total (`12` safe / `0` caution / `0` critical) |
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>InventoryGui.cs:270</code></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><code>InventoryGui.cs:500</code></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><code>ItemManager.cs:1862</code></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><code>ItemManager.cs:1863</code></td>
    </tr>
    <tr>
...
| **`ShieldMeBruh`** | 🟡 MEDIUM | *None* | `InventoryGui.Show`<br>`InventoryGrid.UpdateGui`<br>`Inventory.MoveItemToThis`<br>`Inventory.MoveItemToThis`<br>`Inventory.RemoveItem`<br>`InventoryGrid.DropItem` | `Inventory`, `InventoryGrid`, `InventoryGui`, `ItemDrop`, `Version` |
